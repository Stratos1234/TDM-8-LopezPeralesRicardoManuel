...
import  mx.edu.ittepic.a3_3_laboratorio.CardListAdapter;

public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {

    private mx.edu.ittepic.a3_3_laboratorio.Helper.RecyclerItemTouchHelperListener listener;

    public RecyclerItemTouchHelper(int dragDirs, int swipeDirs,  mx.edu.ittepic.a3_3_laboratorio.Helper.RecyclerItemTouchHelperListener listener) {
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder){
        View foregroudView = ((CardListAdapter.MyViewHolder)viewHolder).viewForeground;
